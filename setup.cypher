  CREATE (person:Category {name: "People", path: "people"}),
    ...
    (slipknot:Thing {name: "Slipknot", path: "slipknot", schemaUrl: "http://www.slipknot1.com/", image: "http://www.slipknot1.com/home/img/bg_group.jpg", tagQuery: "music/slipknot", interviewable: "true"}),
    (dc)-[:IS_A]->(person),
    (dc)-[:IS_A]->(politician),
