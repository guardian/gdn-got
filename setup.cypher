  CREATE (person:Category {name: "People", path: "people"}),
    ...
    (dwj:Thing {name: "Diana Wynne-Jones", path: "diana-wynne-jones", schemaUrl: "http://www.leemac.freeserve.co.uk/", tagQuery: "books/dianawynnejones", image: "http://i.guim.co.uk/static/w-620/h--/q-95/sys-images/Guardian/Pix/pictures/2014/2/17/1392652123198/Diana-Wynne-Jones-008.jpg"}),
    (dc)-[:IS_A]->(person),
    (dc)-[:IS_A]->(politician),
