CREATE (person:Category {name: "People", path: "people"}),
  ...
  (dc:Thing {name: "David Cameron", path: "david-cameron", contributorId: "profile/davidcameron", capiQuery: "politics/davidcameron", schemaName: "David Cameron"}),
  (gb:Thing {name: "Gordon Brown", path: "gordon-brown", schemaName: "Gordon Brown", capiQuery: "politics/gordon-browns"}),
